...
- Inform teachers of which students may need additional assistance or support.  
- Allow parents to understand their child's learning changes and encourage better study habits.  
- Enable educational organizations to try a solution based on AI analytics to changing practice and resource orientation.  

While this version is a simplistic prototype, it can be scaled into a more comprehensive service (such as previous grades, participation, or socio-economic measures), and integrated into an educational process.

INTENDED USERS
- Learners: To learn about the relationship between study habits and attendance and students' performance.  
- Students: To track their studies and grade 
- Teachers: Helps in tracking students records and distinguish between the ones that need more attention

HIGH LEVEL FEATURES
- Data Preparation: Takes raw student record data and prepares it into features (bias, hours studied, attendance rate).  
